...
(%gdext.util:defifun ("get_godot_version" get-godot-version)
    :void
  (r-godot-version (:pointer %gdext.types::godot-version)))

(%gdext.util:defifun ("get_godot_version2" get-godot-version2)
    :void
  (r-godot-version (:pointer %gdext.types::godot-version-2)))

(%gdext.util:defifun ("mem_alloc" mem-alloc)
    (:pointer :void)
  (p-bytes :size))

(%gdext.util:defifun ("mem_realloc" mem-realloc)
    (:pointer :void)
  (p-ptr (:pointer :void))
  (p-bytes :size))

(%gdext.util:defifun ("mem_free" mem-free)
    :void
  (p-ptr (:pointer :void)))

(%gdext.util:defifun ("mem_alloc2" mem-alloc2)
    (:pointer :void)
  (p-bytes :size)
  (p-pad-align %gdext.types::bool))

(%gdext.util:defifun ("mem_realloc2" mem-realloc2)
    (:pointer :void)
  (p-ptr (:pointer :void))
  (p-bytes :size)
  (p-pad-align %gdext.types::bool))

(%gdext.util:defifun ("mem_free2" mem-free2)
    :void
  (p-ptr (:pointer :void))
  (p-pad-align %gdext.types::bool))

(%gdext.util:defifun ("print_error" print-error)
    :void
...
(%gdext.util:defifun ("print_error_with_message" print-error-with-message)
    :void
  (p-description (:pointer :char))
...
(%gdext.util:defifun ("print_warning" print-warning)
    :void
  (p-description (:pointer :char))
  (p-function (:pointer :char))
  (p-file (:pointer :char))
...
(%gdext.util:defifun ("print_warning_with_message" print-warning-with-message)
    :void
  (p-description (:pointer :char))
  (p-message (:pointer :char))
  (p-function (:pointer :char))
...
(%gdext.util:defifun ("print_script_error" print-script-error)
    :void
  (p-description (:pointer :char))
  (p-function (:pointer :char))
  (p-file (:pointer :char))
...
(%gdext.util:defifun ("print_script_error_with_message"
...
(%gdext.util:defifun ("get_native_struct_size" get-native-struct-size)
    :uint64
  (p-name %gdext.types::const-string-name-ptr))

(%gdext.util:defifun ("variant_new_copy" variant-new-copy)
    :void
  (r-dest %gdext.types::uninitialized-variant-ptr)
  (p-src %gdext.types::const-variant-ptr))

(%gdext.util:defifun ("variant_new_nil" variant-new-nil)
    :void
  (r-dest %gdext.types::uninitialized-variant-ptr))

(%gdext.util:defifun ("variant_destroy" variant-destroy)
    :void
  (p-self %gdext.types::variant-ptr))

(%gdext.util:defifun ("variant_call" variant-call)
    :void
  (p-self %gdext.types::variant-ptr)
...
(%gdext.util:defifun ("variant_call_static" variant-call-static)
    :void
...
(%gdext.util:defifun ("variant_evaluate" variant-evaluate)
    :void
...
(%gdext.util:defifun ("variant_set" variant-set)
    :void
  (p-self %gdext.types::variant-ptr)
...
(%gdext.util:defifun ("variant_set_named" variant-set-named)
    :void
  (p-self %gdext.types::variant-ptr)
...
(%gdext.util:defifun ("variant_set_keyed" variant-set-keyed)
    :void
  (p-self %gdext.types::variant-ptr)
  (p-key %gdext.types::const-variant-ptr)
  (p-value %gdext.types::const-variant-ptr)
...
(%gdext.util:defifun ("variant_set_indexed" variant-set-indexed)
    :void
  (p-self %gdext.types::variant-ptr)
...
(%gdext.util:defifun ("variant_get" variant-get)
    :void
...
(%gdext.util:defifun ("variant_get_named" variant-get-named)
    :void
  (p-self %gdext.types::const-variant-ptr)
  (p-key %gdext.types::const-string-name-ptr)
  (r-ret %gdext.types::uninitialized-variant-ptr)
...
(%gdext.util:defifun ("variant_get_keyed" variant-get-keyed)
    :void
  (p-self %gdext.types::const-variant-ptr)
  (p-key %gdext.types::const-variant-ptr)
  (r-ret %gdext.types::uninitialized-variant-ptr)
...
(%gdext.util:defifun ("variant_get_indexed" variant-get-indexed)
    :void
  (p-self %gdext.types::const-variant-ptr)
  (p-index %gdext.types::int)
  (r-ret %gdext.types::uninitialized-variant-ptr)
...
(%gdext.util:defifun ("variant_iter_init" variant-iter-init)
    %gdext.types::bool
  (p-self %gdext.types::const-variant-ptr)
  (r-iter %gdext.types::uninitialized-variant-ptr)
  (r-valid (:pointer %gdext.types::bool)))

(%gdext.util:defifun ("variant_iter_next" variant-iter-next)
    %gdext.types::bool
  (p-self %gdext.types::const-variant-ptr)
  (r-iter %gdext.types::variant-ptr)
  (r-valid (:pointer %gdext.types::bool)))

(%gdext.util:defifun ("variant_iter_get" variant-iter-get)
    :void
  (p-self %gdext.types::const-variant-ptr)
  (r-iter %gdext.types::variant-ptr)
  (r-ret %gdext.types::uninitialized-variant-ptr)
...
(%gdext.util:defifun ("variant_hash" variant-hash)
    %gdext.types::int
  (p-self %gdext.types::const-variant-ptr))

(%gdext.util:defifun ("variant_recursive_hash" variant-recursive-hash)
    %gdext.types::int
  (p-self %gdext.types::const-variant-ptr)
  (p-recursion-count %gdext.types::int))

(%gdext.util:defifun ("variant_hash_compare" variant-hash-compare)
    %gdext.types::bool
  (p-self %gdext.types::const-variant-ptr)
  (p-other %gdext.types::const-variant-ptr))

(%gdext.util:defifun ("variant_booleanize" variant-booleanize)
    %gdext.types::bool
  (p-self %gdext.types::const-variant-ptr))

(%gdext.util:defifun ("variant_duplicate" variant-duplicate)
    :void
  (p-self %gdext.types::const-variant-ptr)
  (r-ret %gdext.types::variant-ptr)
  (p-deep %gdext.types::bool))

(%gdext.util:defifun ("variant_stringify" variant-stringify)
    :void
  (p-self %gdext.types::const-variant-ptr)
  (r-ret %gdext.types::string-ptr))

(%gdext.util:defifun ("variant_get_type" variant-get-type)
    %gdext.types::variant-type
  (p-self %gdext.types::const-variant-ptr))

(%gdext.util:defifun ("variant_has_method" variant-has-method)
    %gdext.types::bool
  (p-self %gdext.types::const-variant-ptr)
  (p-method %gdext.types::const-string-name-ptr))

(%gdext.util:defifun ("variant_has_member" variant-has-member)
    %gdext.types::bool
  (p-type %gdext.types::variant-type)
  (p-member %gdext.types::const-string-name-ptr))

(%gdext.util:defifun ("variant_has_key" variant-has-key)
    %gdext.types::bool
  (p-self %gdext.types::const-variant-ptr)
  (p-key %gdext.types::const-variant-ptr)
  (r-valid (:pointer %gdext.types::bool)))

(%gdext.util:defifun ("variant_get_object_instance_id"
                      variant-get-object-instance-id)
    %gdext.types::instance-id
  (p-self %gdext.types::const-variant-ptr))

(%gdext.util:defifun ("variant_get_type_name" variant-get-type-name)
    :void
  (p-type %gdext.types::variant-type)
  (r-name %gdext.types::uninitialized-string-ptr))

(%gdext.util:defifun ("variant_can_convert" variant-can-convert)
    %gdext.types::bool
  (p-from %gdext.types::variant-type)
  (p-to %gdext.types::variant-type))

(%gdext.util:defifun ("variant_can_convert_strict" variant-can-convert-strict)
    %gdext.types::bool
  (p-from %gdext.types::variant-type)
  (p-to %gdext.types::variant-type))

(%gdext.util:defifun ("get_variant_from_type_constructor"
                      get-variant-from-type-constructor)
    %gdext.types::variant-from-type-constructor-func
  (p-type %gdext.types::variant-type))

(%gdext.util:defifun ("get_variant_to_type_constructor"
                      get-variant-to-type-constructor)
    %gdext.types::type-from-variant-constructor-func
  (p-type %gdext.types::variant-type))

(%gdext.util:defifun ("variant_get_ptr_internal_getter"
                      variant-get-ptr-internal-getter)
    %gdext.types::variant-get-internal-ptr-func
  (p-type %gdext.types::variant-type))

(%gdext.util:defifun ("variant_get_ptr_operator_evaluator"
...
(%gdext.util:defifun ("variant_get_ptr_builtin_method"
...
(%gdext.util:defifun ("variant_get_ptr_constructor" variant-get-ptr-constructor)
    %gdext.types::ptr-constructor
  (p-type %gdext.types::variant-type)
  (p-constructor :int32))

(%gdext.util:defifun ("variant_get_ptr_destructor" variant-get-ptr-destructor)
    %gdext.types::ptr-destructor
  (p-type %gdext.types::variant-type))

(%gdext.util:defifun ("variant_construct" variant-construct)
    :void
  (p-type %gdext.types::variant-type)
...
(%gdext.util:defifun ("variant_get_ptr_setter" variant-get-ptr-setter)
    %gdext.types::ptr-setter
  (p-type %gdext.types::variant-type)
  (p-member %gdext.types::const-string-name-ptr))

(%gdext.util:defifun ("variant_get_ptr_getter" variant-get-ptr-getter)
    %gdext.types::ptr-getter
  (p-type %gdext.types::variant-type)
  (p-member %gdext.types::const-string-name-ptr))

(%gdext.util:defifun ("variant_get_ptr_indexed_setter"
                      variant-get-ptr-indexed-setter)
    %gdext.types::ptr-indexed-setter
  (p-type %gdext.types::variant-type))

(%gdext.util:defifun ("variant_get_ptr_indexed_getter"
                      variant-get-ptr-indexed-getter)
    %gdext.types::ptr-indexed-getter
  (p-type %gdext.types::variant-type))

(%gdext.util:defifun ("variant_get_ptr_keyed_setter"
                      variant-get-ptr-keyed-setter)
    %gdext.types::ptr-keyed-setter
  (p-type %gdext.types::variant-type))

(%gdext.util:defifun ("variant_get_ptr_keyed_getter"
                      variant-get-ptr-keyed-getter)
    %gdext.types::ptr-keyed-getter
  (p-type %gdext.types::variant-type))

(%gdext.util:defifun ("variant_get_ptr_keyed_checker"
                      variant-get-ptr-keyed-checker)
    %gdext.types::ptr-keyed-checker
  (p-type %gdext.types::variant-type))

(%gdext.util:defifun ("variant_get_constant_value" variant-get-constant-value)
    :void
  (p-type %gdext.types::variant-type)
  (p-constant %gdext.types::const-string-name-ptr)
  (r-ret %gdext.types::uninitialized-variant-ptr))

(%gdext.util:defifun ("variant_get_ptr_utility_function"
                      variant-get-ptr-utility-function)
    %gdext.types::ptr-utility-function
  (p-function %gdext.types::const-string-name-ptr)
  (p-hash %gdext.types::int))

(%gdext.util:defifun ("string_new_with_latin1_chars"
                      string-new-with-latin1-chars)
    :void
  (r-dest %gdext.types::uninitialized-string-ptr)
  (p-contents (:pointer :char)))

(%gdext.util:defifun ("string_new_with_utf8_chars" string-new-with-utf8-chars)
    :void
  (r-dest %gdext.types::uninitialized-string-ptr)
  (p-contents (:pointer :char)))

(%gdext.util:defifun ("string_new_with_utf16_chars" string-new-with-utf16-chars)
    :void
  (r-dest %gdext.types::uninitialized-string-ptr)
  (p-contents (:pointer :uint16)))

(%gdext.util:defifun ("string_new_with_utf32_chars" string-new-with-utf32-chars)
    :void
  (r-dest %gdext.types::uninitialized-string-ptr)
  (p-contents (:pointer :uint32)))

(%gdext.util:defifun ("string_new_with_wide_chars" string-new-with-wide-chars)
    :void
  (r-dest %gdext.types::uninitialized-string-ptr)
  (p-contents (:pointer %gdext.util:wchar)))

(%gdext.util:defifun ("string_new_with_latin1_chars_and_len"
...
(%gdext.util:defifun ("string_new_with_utf8_chars_and_len"
...
(%gdext.util:defifun ("string_new_with_utf8_chars_and_len2"
...
(%gdext.util:defifun ("string_new_with_utf16_chars_and_len"
...
(%gdext.util:defifun ("string_new_with_utf16_chars_and_len2"
...
(%gdext.util:defifun ("string_new_with_utf32_chars_and_len"
...
(%gdext.util:defifun ("string_new_with_wide_chars_and_len"
...
(%gdext.util:defifun ("string_to_latin1_chars" string-to-latin1-chars)
    %gdext.types::int
  (p-self %gdext.types::const-string-ptr)
  (r-text (:pointer :char))
  (p-max-write-length %gdext.types::int))

(%gdext.util:defifun ("string_to_utf8_chars" string-to-utf8-chars)
    %gdext.types::int
  (p-self %gdext.types::const-string-ptr)
  (r-text (:pointer :char))
  (p-max-write-length %gdext.types::int))

(%gdext.util:defifun ("string_to_utf16_chars" string-to-utf16-chars)
    %gdext.types::int
  (p-self %gdext.types::const-string-ptr)
  (r-text (:pointer :uint16))
  (p-max-write-length %gdext.types::int))

(%gdext.util:defifun ("string_to_utf32_chars" string-to-utf32-chars)
    %gdext.types::int
  (p-self %gdext.types::const-string-ptr)
  (r-text (:pointer :uint32))
  (p-max-write-length %gdext.types::int))

(%gdext.util:defifun ("string_to_wide_chars" string-to-wide-chars)
    %gdext.types::int
  (p-self %gdext.types::const-string-ptr)
  (r-text (:pointer %gdext.util:wchar))
  (p-max-write-length %gdext.types::int))

(%gdext.util:defifun ("string_operator_index" string-operator-index)
    (:pointer :uint32)
  (p-self %gdext.types::string-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("string_operator_index_const" string-operator-index-const)
    (:pointer :uint32)
  (p-self %gdext.types::const-string-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("string_operator_plus_eq_string"
                      string-operator-plus-eq-string)
    :void
  (p-self %gdext.types::string-ptr)
  (p-b %gdext.types::const-string-ptr))

(%gdext.util:defifun ("string_operator_plus_eq_char"
                      string-operator-plus-eq-char)
    :void
  (p-self %gdext.types::string-ptr)
  (p-b :uint32))

(%gdext.util:defifun ("string_operator_plus_eq_cstr"
                      string-operator-plus-eq-cstr)
    :void
  (p-self %gdext.types::string-ptr)
  (p-b (:pointer :char)))

(%gdext.util:defifun ("string_operator_plus_eq_wcstr"
                      string-operator-plus-eq-wcstr)
    :void
  (p-self %gdext.types::string-ptr)
  (p-b (:pointer %gdext.util:wchar)))

(%gdext.util:defifun ("string_operator_plus_eq_c32str"
                      string-operator-plus-eq-c32str)
    :void
  (p-self %gdext.types::string-ptr)
  (p-b (:pointer :uint32)))

(%gdext.util:defifun ("string_resize" string-resize)
    %gdext.types::int
  (p-self %gdext.types::string-ptr)
  (p-resize %gdext.types::int))

(%gdext.util:defifun ("string_name_new_with_latin1_chars"
...
(%gdext.util:defifun ("string_name_new_with_utf8_chars"
                      string-name-new-with-utf8-chars)
    :void
  (r-dest %gdext.types::uninitialized-string-name-ptr)
  (p-contents (:pointer :char)))

(%gdext.util:defifun ("string_name_new_with_utf8_chars_and_len"
...
(%gdext.util:defifun ("xml_parser_open_buffer" xml-parser-open-buffer)
    %gdext.types::int
  (p-instance %gdext.types::object-ptr)
  (p-buffer (:pointer :uint8))
  (p-size :size))

(%gdext.util:defifun ("file_access_store_buffer" file-access-store-buffer)
    :void
  (p-instance %gdext.types::object-ptr)
  (p-src (:pointer :uint8))
  (p-length :uint64))

(%gdext.util:defifun ("file_access_get_buffer" file-access-get-buffer)
    :uint64
  (p-instance %gdext.types::const-object-ptr)
  (p-dst (:pointer :uint8))
  (p-length :uint64))

(%gdext.util:defifun ("image_ptrw" image-ptrw)
    (:pointer :uint8)
  (p-instance %gdext.types::object-ptr))

(%gdext.util:defifun ("image_ptr" image-ptr)
    (:pointer :uint8)
  (p-instance %gdext.types::object-ptr))

(%gdext.util:defifun ("worker_thread_pool_add_native_group_task"
...
(%gdext.util:defifun ("worker_thread_pool_add_native_task"
...
(%gdext.util:defifun ("packed_byte_array_operator_index"
                      packed-byte-array-operator-index)
    (:pointer :uint8)
  (p-self %gdext.types::type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_byte_array_operator_index_const"
                      packed-byte-array-operator-index-const)
    (:pointer :uint8)
  (p-self %gdext.types::const-type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_float32_array_operator_index"
                      packed-float32-array-operator-index)
    (:pointer :float)
  (p-self %gdext.types::type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_float32_array_operator_index_const"
                      packed-float32-array-operator-index-const)
    (:pointer :float)
  (p-self %gdext.types::const-type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_float64_array_operator_index"
                      packed-float64-array-operator-index)
    (:pointer :double)
  (p-self %gdext.types::type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_float64_array_operator_index_const"
                      packed-float64-array-operator-index-const)
    (:pointer :double)
  (p-self %gdext.types::const-type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_int32_array_operator_index"
                      packed-int32-array-operator-index)
    (:pointer :int32)
  (p-self %gdext.types::type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_int32_array_operator_index_const"
                      packed-int32-array-operator-index-const)
    (:pointer :int32)
  (p-self %gdext.types::const-type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_int64_array_operator_index"
                      packed-int64-array-operator-index)
    (:pointer :int64)
  (p-self %gdext.types::type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_int64_array_operator_index_const"
                      packed-int64-array-operator-index-const)
    (:pointer :int64)
  (p-self %gdext.types::const-type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_string_array_operator_index"
                      packed-string-array-operator-index)
    %gdext.types::string-ptr
  (p-self %gdext.types::type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_string_array_operator_index_const"
                      packed-string-array-operator-index-const)
    %gdext.types::string-ptr
  (p-self %gdext.types::const-type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_vector2_array_operator_index"
                      packed-vector2-array-operator-index)
    %gdext.types::type-ptr
  (p-self %gdext.types::type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_vector2_array_operator_index_const"
                      packed-vector2-array-operator-index-const)
    %gdext.types::type-ptr
  (p-self %gdext.types::const-type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_vector3_array_operator_index"
                      packed-vector3-array-operator-index)
    %gdext.types::type-ptr
  (p-self %gdext.types::type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_vector3_array_operator_index_const"
                      packed-vector3-array-operator-index-const)
    %gdext.types::type-ptr
  (p-self %gdext.types::const-type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_vector4_array_operator_index"
                      packed-vector4-array-operator-index)
    %gdext.types::type-ptr
  (p-self %gdext.types::type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_vector4_array_operator_index_const"
                      packed-vector4-array-operator-index-const)
    %gdext.types::type-ptr
  (p-self %gdext.types::const-type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_color_array_operator_index"
                      packed-color-array-operator-index)
    %gdext.types::type-ptr
  (p-self %gdext.types::type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("packed_color_array_operator_index_const"
                      packed-color-array-operator-index-const)
    %gdext.types::type-ptr
  (p-self %gdext.types::const-type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("array_operator_index" array-operator-index)
    %gdext.types::variant-ptr
  (p-self %gdext.types::type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("array_operator_index_const" array-operator-index-const)
    %gdext.types::variant-ptr
  (p-self %gdext.types::const-type-ptr)
  (p-index %gdext.types::int))

(%gdext.util:defifun ("array_ref" array-ref)
    :void
  (p-self %gdext.types::type-ptr)
  (p-from %gdext.types::const-type-ptr))

(%gdext.util:defifun ("array_set_typed" array-set-typed)
    :void
  (p-self %gdext.types::type-ptr)
  (p-type %gdext.types::variant-type)
...
(%gdext.util:defifun ("dictionary_operator_index" dictionary-operator-index)
    %gdext.types::variant-ptr
  (p-self %gdext.types::type-ptr)
  (p-key %gdext.types::const-variant-ptr))

(%gdext.util:defifun ("dictionary_operator_index_const"
                      dictionary-operator-index-const)
    %gdext.types::variant-ptr
  (p-self %gdext.types::const-type-ptr)
  (p-key %gdext.types::const-variant-ptr))

(%gdext.util:defifun ("dictionary_set_typed" dictionary-set-typed)
    :void
  (p-self %gdext.types::type-ptr)
...
(%gdext.util:defifun ("object_method_bind_call" object-method-bind-call)
    :void
...
(%gdext.util:defifun ("object_method_bind_ptrcall" object-method-bind-ptrcall)
    :void
  (p-method-bind %gdext.types::method-bind-ptr)
  (p-instance %gdext.types::object-ptr)
...
(%gdext.util:defifun ("object_destroy" object-destroy)
    :void
  (p-o %gdext.types::object-ptr))

(%gdext.util:defifun ("global_get_singleton" global-get-singleton)
    %gdext.types::object-ptr
  (p-name %gdext.types::const-string-name-ptr))

(%gdext.util:defifun ("object_get_instance_binding" object-get-instance-binding)
    (:pointer :void)
  (p-o %gdext.types::object-ptr)
  (p-token (:pointer :void))
  (p-callbacks (:pointer %gdext.types::instance-binding-callbacks)))

(%gdext.util:defifun ("object_set_instance_binding" object-set-instance-binding)
    :void
  (p-o %gdext.types::object-ptr)
  (p-token (:pointer :void))
...
(%gdext.util:defifun ("object_free_instance_binding"
                      object-free-instance-binding)
    :void
  (p-o %gdext.types::object-ptr)
  (p-token (:pointer :void)))

(%gdext.util:defifun ("object_set_instance" object-set-instance)
    :void
  (p-o %gdext.types::object-ptr)
  (p-classname %gdext.types::const-string-name-ptr)
  (p-instance %gdext.types::class-instance-ptr))

(%gdext.util:defifun ("object_get_class_name" object-get-class-name)
    %gdext.types::bool
...
(%gdext.util:defifun ("object_cast_to" object-cast-to)
    %gdext.types::object-ptr
  (p-object %gdext.types::const-object-ptr)
  (p-class-tag (:pointer :void)))

(%gdext.util:defifun ("object_get_instance_from_id" object-get-instance-from-id)
    %gdext.types::object-ptr
  (p-instance-id %gdext.types::instance-id))

(%gdext.util:defifun ("object_get_instance_id" object-get-instance-id)
    %gdext.types::instance-id
  (p-object %gdext.types::const-object-ptr))

(%gdext.util:defifun ("object_has_script_method" object-has-script-method)
    %gdext.types::bool
  (p-object %gdext.types::const-object-ptr)
  (p-method %gdext.types::const-string-name-ptr))

(%gdext.util:defifun ("object_call_script_method" object-call-script-method)
    :void
...
(%gdext.util:defifun ("ref_get_object" ref-get-object)
    %gdext.types::object-ptr
  (p-ref %gdext.types::const-ref-ptr))

(%gdext.util:defifun ("ref_set_object" ref-set-object)
    :void
  (p-ref %gdext.types::ref-ptr)
  (p-object %gdext.types::object-ptr))

(%gdext.util:defifun ("script_instance_create" script-instance-create)
...
(%gdext.util:defifun ("script_instance_create2" script-instance-create2)
    %gdext.types::script-instance-ptr
  (p-info (:pointer %gdext.types::script-instance-info-2))
  (p-instance-data %gdext.types::script-instance-data-ptr))

(%gdext.util:defifun ("script_instance_create3" script-instance-create3)
    %gdext.types::script-instance-ptr
  (p-info (:pointer %gdext.types::script-instance-info-3))
  (p-instance-data %gdext.types::script-instance-data-ptr))

(%gdext.util:defifun ("placeholder_script_instance_create"
...
(%gdext.util:defifun ("placeholder_script_instance_update"
...
(%gdext.util:defifun ("object_get_script_instance" object-get-script-instance)
    %gdext.types::script-instance-data-ptr
  (p-object %gdext.types::const-object-ptr)
  (p-language %gdext.types::object-ptr))

(%gdext.util:defifun ("object_set_script_instance" object-set-script-instance)
    :void
  (p-object %gdext.types::object-ptr)
  (p-script-instance %gdext.types::script-instance-data-ptr))

(%gdext.util:defifun ("callable_custom_create" callable-custom-create)
    :void
  (r-callable %gdext.types::uninitialized-type-ptr)
  (p-callable-custom-info (:pointer %gdext.types::callable-custom-info)))

(%gdext.util:defifun ("callable_custom_create2" callable-custom-create2)
    :void
  (r-callable %gdext.types::uninitialized-type-ptr)
  (p-callable-custom-info (:pointer %gdext.types::callable-custom-info-2)))

(%gdext.util:defifun ("callable_custom_get_userdata"
                      callable-custom-get-userdata)
    (:pointer :void)
  (p-callable %gdext.types::const-type-ptr)
  (p-token (:pointer :void)))

(%gdext.util:defifun ("classdb_construct_object" classdb-construct-object)
    %gdext.types::object-ptr
  (p-classname %gdext.types::const-string-name-ptr))

(%gdext.util:defifun ("classdb_construct_object2" classdb-construct-object2)
    %gdext.types::object-ptr
  (p-classname %gdext.types::const-string-name-ptr))

(%gdext.util:defifun ("classdb_get_method_bind" classdb-get-method-bind)
    %gdext.types::method-bind-ptr
  (p-classname %gdext.types::const-string-name-ptr)
  (p-methodname %gdext.types::const-string-name-ptr)
  (p-hash %gdext.types::int))

(%gdext.util:defifun ("classdb_get_class_tag" classdb-get-class-tag)
    (:pointer :void)
  (p-classname %gdext.types::const-string-name-ptr))

(%gdext.util:defifun ("classdb_register_extension_class"
...
(%gdext.util:defifun ("classdb_register_extension_class2"
                      classdb-register-extension-class2)
    :void
  (p-library %gdext.types::class-library-ptr)
  (p-class-name %gdext.types::const-string-name-ptr)
  (p-parent-class-name %gdext.types::const-string-name-ptr)
  (p-extension-funcs (:pointer %gdext.types::class-creation-info-2)))

(%gdext.util:defifun ("classdb_register_extension_class3"
                      classdb-register-extension-class3)
    :void
  (p-library %gdext.types::class-library-ptr)
  (p-class-name %gdext.types::const-string-name-ptr)
  (p-parent-class-name %gdext.types::const-string-name-ptr)
  (p-extension-funcs (:pointer %gdext.types::class-creation-info-3)))

(%gdext.util:defifun ("classdb_register_extension_class4"
                      classdb-register-extension-class4)
    :void
  (p-library %gdext.types::class-library-ptr)
  (p-class-name %gdext.types::const-string-name-ptr)
  (p-parent-class-name %gdext.types::const-string-name-ptr)
  (p-extension-funcs (:pointer %gdext.types::class-creation-info-4)))

(%gdext.util:defifun ("classdb_register_extension_class5"
                      classdb-register-extension-class5)
    :void
  (p-library %gdext.types::class-library-ptr)
  (p-class-name %gdext.types::const-string-name-ptr)
  (p-parent-class-name %gdext.types::const-string-name-ptr)
  (p-extension-funcs (:pointer %gdext.types::class-creation-info-5)))

(%gdext.util:defifun ("classdb_register_extension_class_method"
...
(%gdext.util:defifun ("classdb_register_extension_class_virtual_method"
...
(%gdext.util:defifun ("classdb_register_extension_class_integer_constant"
...
(%gdext.util:defifun ("classdb_register_extension_class_property"
...
(%gdext.util:defifun ("classdb_register_extension_class_property_indexed"
...
(%gdext.util:defifun ("classdb_register_extension_class_property_group"
...
(%gdext.util:defifun ("classdb_register_extension_class_property_subgroup"
...
(%gdext.util:defifun ("classdb_register_extension_class_signal"
...
(%gdext.util:defifun ("classdb_unregister_extension_class"
                      classdb-unregister-extension-class)
    :void
  (p-library %gdext.types::class-library-ptr)
  (p-class-name %gdext.types::const-string-name-ptr))

(%gdext.util:defifun ("get_library_path" get-library-path)
    :void
  (p-library %gdext.types::class-library-ptr)
  (r-path %gdext.types::uninitialized-string-ptr))

(%gdext.util:defifun ("editor_add_plugin" editor-add-plugin)
    :void
  (p-class-name %gdext.types::const-string-name-ptr))

(%gdext.util:defifun ("editor_remove_plugin" editor-remove-plugin)
    :void
  (p-class-name %gdext.types::const-string-name-ptr))

(%gdext.util:defifun ("editor_help_load_xml_from_utf8_chars"
                      editor-help-load-xml-from-utf8-chars)
    :void
  (p-data (:pointer :char)))

(%gdext.util:defifun ("editor_help_load_xml_from_utf8_chars_and_len"
                      editor-help-load-xml-from-utf8-chars-and-len)
    :void
  (p-data (:pointer :char))
  (p-size %gdext.types::int))

(%gdext.util:defifun ("editor_register_get_classes_used_callback"
                      editor-register-get-classes-used-callback)
    :void
  (p-library %gdext.types::class-library-ptr)
  (p-callback %gdext.types::editor-get-classes-used-callback))

(%gdext.util:defifun ("register_main_loop_callbacks"
