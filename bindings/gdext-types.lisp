...
(%gdext.util:defcfunproto class-free-property-list-2
    :void
  class-instance-ptr
  (:pointer property-info)
  :uint32)
...
(%gdext.util:defcfunproto class-notification-2
    :void
  class-instance-ptr
  :int32
  bool)
...
(%gdext.util:defcfunproto class-create-instance-2
    object-ptr
  (:pointer :void)
  bool)
...
(%gdext.util:defcfunproto class-get-virtual-2
    class-call-virtual
  (:pointer :void)
  const-string-name-ptr
  :uint32)
...
(%gdext.util:defcfunproto class-get-virtual-call-data-2
    (:pointer :void)
  (:pointer :void)
  const-string-name-ptr
  :uint32)
...
(%gdext.util:defcfunproto script-instance-free-property-list-2
    :void
  script-instance-data-ptr
  (:pointer property-info)
  :uint32)
...
(%gdext.util:defcfunproto script-instance-free-method-list-2
    :void
  script-instance-data-ptr
  (:pointer method-info)
  :uint32)
...
(%gdext.util:defcfunproto script-instance-notification-2
    :void
  script-instance-data-ptr
  :int32
  bool)
...
(common-lisp:export
 '(variant-type variant-operator variant-ptr const-variant-ptr
   ...
   class-free-property-list class-free-property-list-2
   class-property-can-revert class-property-get-revert class-validate-property
   class-notification class-notification-2 class-to-string class-reference
   class-unreference class-call-virtual class-create-instance
   class-create-instance-2 class-free-instance class-recreate-instance
   class-get-virtual class-get-virtual-2 class-get-virtual-call-data
   class-get-virtual-call-data-2 class-call-virtual-with-data
   class-creation-info is-virtual is-abstract set-func get-func
   get-property-list-func free-property-list-func property-can-revert-func
   property-get-revert-func notification-func to-string-func reference-func
   unreference-func create-instance-func free-instance-func get-virtual-func
   get-rid-func class-userdata class-creation-info-2 is-virtual is-abstract
   is-exposed set-func get-func get-property-list-func free-property-list-func
   ...
   get-rid-func class-userdata class-creation-info-3 is-virtual is-abstract
   is-exposed is-runtime set-func get-func get-property-list-func
   ...
   call-virtual-with-data-func get-rid-func class-userdata
   class-creation-info-4 is-virtual is-abstract is-exposed is-runtime icon-path
   set-func get-func get-property-list-func free-property-list-func
   property-can-revert-func property-get-revert-func validate-property-func
   notification-func to-string-func reference-func unreference-func
   create-instance-func free-instance-func recreate-instance-func
   get-virtual-func get-virtual-call-data-func call-virtual-with-data-func
   class-userdata class-creation-info-5 class-library-ptr
   editor-get-classes-used-callback class-method-flags
   ...
   less-than-func to-string-func callable-custom-info-2 callable-userdata token
   ...
   script-instance-free-property-list-2 script-instance-get-class-category
   ...
   script-instance-free-method-list script-instance-free-method-list-2
   script-instance-has-method script-instance-get-method-argument-count
   script-instance-call script-instance-notification
   script-instance-notification-2 script-instance-to-string
   ...
   free-func script-instance-info-2 set-func get-func get-property-list-func
   ...
   get-language-func free-func script-instance-info-3 set-func get-func
   ...
   godot-version major minor patch string godot-version-2 major minor patch hex
