...
(defgenum (scroll-container+scroll-mode :class 'scroll-container) (:disabled 0)
 (:auto 1) (:show-always 2) (:show-never 3) (:reserve 4))
...
(defgenum (visual-shader+type :class 'visual-shader) (:vertex 0) (:fragment 1)
 ...
 (:process-custom 7) (:sky 8) (:fog 9) (:max 10))
...
(defgclass (xrcontroller-3d :bind "XRController3D" :api :core)
 (:signals (button-pressed name string) (button-released name string)
  (input-float-changed name string value float)
  (input-vector2-changed name string value vector-2)
...
(defgclass (animation-library :bind "AnimationLibrary" :api :core)
 (:signals (animation-added name string-name)
  (animation-removed name string-name)
  (animation-renamed name string-name to-name string-name)
  (animation-changed name string-name)))
...
(defgenum
 ...
 (:script-editor-code 4) (:scene-tabs 5) (:2d-editor 6))
...
(defgclass (script-editor-base :bind "ScriptEditorBase" :api :editor)
 (:signals (name-changed) (edited-script-changed) (request-help topic string)
  (request-open-script-at-line script object line int) (request-save-history)
  (request-save-previous-state state dictionary) (go-to-help what string)
  (search-in-files-requested text string)
...
(defgclass (editor-dock :bind "EditorDock" :api :editor) (:signals (closed)))
...
(defgenum (editor-dock+dock-slot :class 'editor-dock) (:none -1) (:left-ul 0)
 ...
 (:right-ur 6) (:right-br 7) (:bottom 8) (:max 9))
...
(defgclass
 ...
 (:signals (spatial-tracking-state-changed spatial-tracking-state int)))
...
(defgenum (viewport+scaling-3dmode :class 'viewport) (:bilinear 0) (:fsr 1)
 (:fsr2 2) (:metalfx-spatial 3) (:metalfx-temporal 4) (:max 5))
...
(defgclass (xrserver :bind "XRServer" :api :core)
 (:signals (reference-frame-changed)
  ...
  (tracker-removed tracker-name string-name type int)))
...
(defgclass (xrpositional-tracker :bind "XRPositionalTracker" :api :core)
 (:signals (pose-changed pose xrpose) (pose-lost-tracking pose xrpose)
  (button-pressed name string) (button-released name string)
  (input-float-changed name string value float)
  (input-vector2-changed name string vector vector-2)
  (profile-changed role string)))
...
(defgenum
 ...
 (:tooltip 64) (:width-in-percent 128))
...
(defgenum (rendering-server+shader-mode :class 'rendering-server) (:spatial 0)
 (:canvas-item 1) (:particles 2) (:sky 3) (:fog 4) (:max 5))
...
(defgenum (rendering-device+uniform-type :class 'rendering-device) (:sampler 0)
 ...
 (:storage-buffer-dynamic 11) (:max 12))
...
(defgenum (rendering-device+shader-stage :class 'rendering-device) (:vertex 0)
 ...
 (:compute 4) (:max 5) (:vertex-bit 1) (:fragment-bit 2)
...
(defgenum (display-server+feature :class 'display-server) (:global-menu 0)
 ...
 (:accessibility-screen-reader 34))
...
(defgenum (code-edit+code-completion-kind :class 'code-edit) (:class 0)
 ...
 (:node-path 7) (:file-path 8) (:plain-text 9))
...
(defgclass (animation-player :bind "AnimationPlayer" :api :core)
 (:signals (current-animation-changed name string-name)
...
(defgclass (animation-node :bind "AnimationNode" :api :core)
 (:signals (tree-changed)
  (animation-node-renamed object-id int old-name string new-name string)
  (animation-node-removed object-id int name string)))
...
(defgenum
 ...
 (:constant 6) (:node-path 7) (:file-path 8) (:plain-text 9) (:max 10))
...
(defgenum (object+connect-flags :class 'object) (:deferred 1) (:persist 2)
 (:one-shot 4) (:reference-counted 8) (:append-source-object 16))